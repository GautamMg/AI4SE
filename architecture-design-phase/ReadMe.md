...
The goal of this phase is to turn project requirements into a testable, review-ready architecture with clear traceability across all artifacts.
...
7. Traceability Matrix (RTM) linking requirements, ADRs, and diagrams
